...
###########################################################################################################
###########################################################################################################
# This script generates a number of simulated (1) multiphase powder diffraction patterns for icosahedral 
# quasicrystal phases, "multi-QC" and (2) randomly generated powder diffraction patterns, "non-QC".
###########################################################################################################
###########################################################################################################
###########################################################################################################
